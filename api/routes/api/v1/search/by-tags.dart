...
Future<Response> onRequest(RequestContext context) async {
  ...
  final lat = context.request.uri.queryParameters['lat'].doubleParse();
  final lng = context.request.uri.queryParameters['lng'].doubleParse();

  final body = await context.safeJson();
  if (body == null) return Response(statusCode: HttpStatus.badRequest);
